...
const PackageCreditCard: React.FC<CreditCardProps> = ({data}) => {
  return (
    <LinearGradient
      colors={['rgba(254, 211, 118, 1)', 'rgba(254, 211, 118, 0.2)', '#2a2d33']}
      locations={[0, 0, 1]}
      start={{x: 1, y: 0}}
      style={{
        height: 80,
      ...
      <View className="flex-1 p-[1px] w-full  relative z-10 overflow-hidden ">
        <View className="flex-1 Container  py-4 px-5 w-[180px] dark:bg-neutral-dark-300 bg-neutral-0/20 rounded-3xl gap-3">
          <View className="flex-row gap-1 z-10">
            <FlashCircle size="20" color="#fed376" variant="Bold" />
            <BaseText
              type="title4"
              color="base"
...
export default PackageCreditCard;
