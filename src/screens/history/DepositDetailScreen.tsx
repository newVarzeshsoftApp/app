...
type DepositDetailScreenProps = NativeStackScreenProps<
  ...
  'DepositDetail'
>;
const DepositDetailScreen: React.FC<DepositDetailScreenProps> = ({
  navigation,
  route,
}) => {
          ...
          <View className="flex-1 pt-[30%]">
            <LinearGradient
              ...
              <View className="flex-1 p-[1.5px] w-full  relative z-10 ">
                <View className="absolute -top-[20%] web:-top-[20px]  z-20 left-1/2 transform web:-translate-x-1/2 w-[44px] h-[44px] items-center justify-center rounded-full bg-success-100 dark:bg-success-dark-100 border border-success-500">
                  <MoneyRecive size="24" color="#37C976" variant="Bold" />
                </View>
