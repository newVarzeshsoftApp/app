...
type PackageServiceProp = NativeStackScreenProps<
  ...
  'packageService'
>;
const PackageServiceScreen: React.FC<PackageServiceProp> = ({
  navigation,
  route,
}) => {
  ...
  const {data: CategoryData, isLoading: CategoryIsLoading} = useGetCategory({
    type: {equals: ProductType.Package},
  });
    ...
    <View className="flex-1">
      ...
      <Animated.FlatList
        ...
        contentContainerStyle={{
          paddingTop: 90,
          paddingBottom: ProductIsLoading
            ? 40
            : Platform.OS === 'web'
            ? 100
            : 20,
...
export default PackageServiceScreen;
